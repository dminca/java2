...
public class MainFrame extends javax.swing.JFrame {
    ...
    public MainFrame() {
        ...
        MainController.getInstance().addAngajatListener(
                new AngajatListener() {
    ...
    private void afisareAngajati(){
        model.clear();
        List<AngajatDB> angajati = MainController.getInstance().getAngajati();
